...
export function* RelatedBookmarksSaga({ type, payload }) {
    try {
        // console.log('Related Books Saga . . . .  .1', payload);
        const response = yield call(() =>
            RestClient.get(`${API_ENDPOINTS.relatedBookmarks}/${payload.product_id}`),
        );
        ...
        console.log('Related BookMarks Saga Response . . . .  .', data.data);
        if (status === 200) {
