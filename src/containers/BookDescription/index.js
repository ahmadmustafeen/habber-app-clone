...
import {RoundIcon,Counter} from '../../components';
...
`}
        ...
        <View>
            <AppText bold size={15} primary>ISBN: 978-3-16-141500-0</AppText>
            <AppText bold size={15}>Pages: 160</AppText>
            <AppText bold size={15}>Type of Cover: Hard Cover</AppText>
            <AppText bold size={15}>Genre: Romance|Thriller|Mystery</AppText>
        </View>

        <View style={{marginTop:20}}>
            <AppText bold size={18} style={{marginBottom:10}}>Description:</AppText>
            <AppText size={14} color="#202020">{`We are the best world Information Technology Company. 
