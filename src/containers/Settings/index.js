...
import { View, StyleSheet, Switch, Picker, I18nManager, Text, Modal, TouchableOpacity } from 'react-native';
      ...
      <>
        <TouchableOpacity
          ...
          style={{
            ...
            width: wp(87),
            borderLeftColor: colors.borderColor, borderLeftWidth: 4,
            height: hp(3), alignItems: 'center',
            justifyContent: 'space-between', flexDirection: 'row'
          }}>
          <AppText color={colors.borderColor} style={{ paddingLeft: wp(2) }} >{props.currencyName}</AppText>
          <Icon
            size={15}
        ...
        <View style={{ borderBottomWidth: 1, borderColor: colors.borderColor, width: wp(100) }} />
      </>
    )
  }
  ...
  return (
    <Screen>
      ...
      <View key="content" style={styles.content}>
        ...
        />
        <SettingsComponent label="Language" onIconPress={() => {
          setModalVisible(!modalVisible);
        }} />
        {modalVisible &&
          <View style={{ width: wp(80), alignSelf: "flex-end", marginVertical: hp(1), }}>
            <CurrencyDropDown currencyName="English" iconName="dollar" iconType="font-awesome" />
            <CurrencyDropDown currencyName="Arabic" iconName="dollar" iconType="font-awesome" />
          </View>
        }

        <SettingsComponent label="Currency" onIconPress={() => showCurrencyDrop(!currencyDrop)} />
        {currencyDrop &&
          <View style={{ width: wp(80), alignSelf: "flex-end", marginVertical: hp(1), }}>
            <CurrencyDropDown currencyName="Dollar" iconName="dollar" iconType="font-awesome" />
            <CurrencyDropDown currencyName="Dollar" iconName="dollar" iconType="font-awesome" />
            <CurrencyDropDown currencyName="Dollar" iconName="dollar" iconType="font-awesome" />
            <CurrencyDropDown currencyName="Dollar" iconName="dollar" iconType="font-awesome" />
          </View>
